...
export default class App extends Component {
  ...
  state = {
    todoData: [
      this.createTodoTask('Completed task', new Date('2024-05-05T13:24:00')),
      this.createTodoTask('Editing task', new Date('2024-05-05T13:24:00')),
      this.createTodoTask('Active task', new Date('2024-05-05T13:24:00')),
    ],
    filter: 'all',
  };
